...
(function (TheDatepicker) {
  ...
  var Datepicker = (function () {
    ...
    Datepicker.prototype.updateContainer_ = function () {
      ...
      var windowTop =
        window.pageYOffset || Datepicker.document_.documentElement.scrollTop;
      var windowLeft =
        window.pageXOffset || Datepicker.document_.documentElement.scrollLeft;
      ...
      var windowHeight =
        ...
        window.innerHeight ||
        Math.max(
          Datepicker.document_.documentElement.clientHeight,
          Datepicker.document_.body.clientHeight
        ) ||
        0;
      var windowWidth =
        viewportWidth ||
        window.innerWidth ||
        Math.max(
          Datepicker.document_.documentElement.clientWidth,
          Datepicker.document_.body.clientWidth
        ) ||
        0;
      ...
      if (
        this.options.isPositionFixingEnabled() &&
      ...
      var locateLeft =
        inputLeft - windowLeft > containerWidth - inputWidth &&
        windowRight - inputRight < containerWidth - inputWidth;
      if (locateOver) {
        TheDatepicker.HtmlHelper_.addClass_(
          this.container,
...
(function (TheDatepicker) {
  ...
  var Template_ = (function () {
    ...
    Template_.prototype.updateTableOfYearsRowsElements_ = function (viewModel) {
      ...
      for (
        var rowIndex = 0;
        rowIndex < this.yearsRowsElements_.length;
        rowIndex++
      ) {
